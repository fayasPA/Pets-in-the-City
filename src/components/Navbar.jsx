...
const Navbar = () => {
  ...
  return (
    <header 
      className={`fixed top-0 w-screen transition-transform duration-500 ease-in-out 
    ...
    >
      <div className=" mx-auto flex flex-wrap items-center justify-between px-4 md:px-8">
        {/* Logo */}
